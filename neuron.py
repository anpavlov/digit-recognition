...
class Neuron(object):
    ...
    def __init__(self, width, a="step", s=1, t=1, l=0.1, e=0.1):
        self.threshold = t
        self.inputs = [0] * width
    ...
    def __str__(self):
        ...
        for i in range(len(self.inputs)):
            out += str(self.inputs[i]) + "\t" + str(self.weights[i]) + "\n"
        out += "THRESHOLD  : " + str(self.threshold) + "\n"
        out += "LEARN RATE : " + str(self.l_rate) + "\n"
        out += "ERR MARGIN : " + str(self.err_margin) + "\n"
        return out
    ...
    def set_input(self, x, i):
        self.inputs[x] = i

    def get_input(self, x):
        return self.inputs[x]

    def set_weight(self, x, w):
        self.weights[x] = w
    ...
    def get_value(self, x):
        return self.weights[x] * self.inputs[x]
